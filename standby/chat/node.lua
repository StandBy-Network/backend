local new_room = require "standby.chat.room".new
local new_neighbour = require "standby.chat.neighbour".new
local subscription_type = require "standby.chat.subscription"
