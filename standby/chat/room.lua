...
local standby.chat_channel = require "standby.chat.channel"
...
function room_methods:new_channel(key, top_msg_id_seen)
	local channel = standby.chat_channel.new(self, key, top_msg_id_seen, self.on_message)
	self:add_channel(channel)
	return channel
end

function room_methods:create_channel()
	local channel = standby.chat_channel.create(self, self.on_message)
	self:add_channel(channel)
	return channel
end
